...
internal sealed record EncounterCombatStepResult
{
    ...
    public required IReadOnlyList<EncounterCombatDieRoll> Dice { get; init; }
    ...
    public EncounterCombatTurnAdvanceReason? TurnAdvanceReason { get; init; }
