...
public sealed class EncounterHealingRulesTests
{
    [Fact]
    public void Resolve_WhenInjuredCombatantIsHealed_AppliesHealingWithoutSpendingResources()
    {
        ...
        Assert.Equal(
            3,
            result.CombatantHealing
                .HealthHealing.HitPointsRestored);
        Assert.Equal(
            9,
    ...
    [Fact]
    public void Resolve_WhenHealingExceedsMissingHitPoints_CapsAtMaximum()
    {
        EncounterState state = CreateEncounter(
            hero: CreateInjuredCombatant(
                "combatant.hero",
    ...
    [Fact]
    public void Resolve_WhenActiveDyingCombatantRegainsHitPoints_ClearsPendingSaveAndResetsProgress()
    {
    ...
    [Fact]
    public void Resolve_WhenNonactiveDyingCombatantIsHealed_BecomesConscious()
    {
        EncounterState state = CreateEncounter(
    ...
    [Fact]
    public void Resolve_WhenAnotherCombatantIsHealed_PreservesActivePendingSave()
    {
        EncounterState state = CreateEncounter(
    ...
    [Fact]
    public void Resolve_WithZeroHealingOnActiveDyingCombatant_PreservesPendingSave()
    {
        EncounterState state = CreateEncounter(
            hero: CreateDyingCombatant(
                "combatant.hero"));
        ...
        long expectedRevision)
    {
        ...
        EncounterHealingCommand command = new()
        {
    ...
    [InlineData(-1)]
    [InlineData(-10)]
    public void Resolve_WithNegativeHealingAmount_Throws(
        int healingAmount)
    {
        EncounterState state = CreateEncounter();
    ...
    private static EncounterHealingCommand
        CreateCommand(
            EncounterState state,
            string targetCombatantId,
            int healingAmount)
    {
        return new EncounterHealingCommand
        {
            ExpectedRevision = state.Revision,
            TargetCombatantId =
                targetCombatantId,
